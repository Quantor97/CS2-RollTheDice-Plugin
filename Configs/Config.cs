...
public class Config
{
	...
	public static void GenerateDefaultGeneralConfig()
	{
		...
		Dictionary<string, object> configGeneral = new() 
		{
			{ "Language", "en" },
			{ "DiceRollsPerRound", 1 },
			{ "BroadcastDiceRoll", false },
			{ "BroadcastDiceRollTerroristOnly", true },
			{ "BroadcastDiceRollCounterTerroristOnly", false },
			{ "BroadcastPluginCommand", true },
			{ "UnicastDiceRoll", false },
			{ "UnicastEffectDescription", true },
			{ "UnicastRollAmount", true },
			{ "TsCanRoll", true},
			{ "CTsCanRoll", false},
