...
public class EffectMirrorDamage : EffectBaseEvent<EventPlayerHurt>, IEffectParamterized
{
    ...
    public override HookResult OnEvent(EventPlayerHurt @event, GameEventInfo eventInfo)
    {
        ...
        PrintMessageOnEvent(attackerController, "effect_event_mirrored_vampire", damageAmount+"");
